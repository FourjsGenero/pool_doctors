...
# generated pool_dataResponseBodyType
PUBLIC TYPE pool_dataResponseBodyType RECORD
    temperature FLOAT,
    hardness FLOAT,
    free_chlorine FLOAT,
    total_chroline FLOAT,
...
PUBLIC FUNCTION pool_data(
    ...
    DEFINE req com.HTTPRequest
    DEFINE resp com.HTTPResponse
    DEFINE resp_body pool_dataResponseBodyType
    ...
    TRY
        ...
        # Prepare request path
        LET fullpath = base.StringBuffer.Create()
        CALL fullpath.append("/pool_data/{l_cm_code}")
...
################################################################################
# Operation /get/{l_cm_code}
#
# VERB: GET
# ID:          get
#
PUBLIC FUNCTION get(p_l_cm_code STRING) RETURNS(INTEGER, getResponseBodyType)
    DEFINE fullpath base.StringBuffer
    DEFINE contentType STRING
    DEFINE req com.HTTPRequest
    DEFINE resp com.HTTPResponse
    ...
    TRY
        ...
        # Prepare request path
        LET fullpath = base.StringBuffer.Create()
        CALL fullpath.append("/get/{l_cm_code}")
        CALL fullpath.replace("{l_cm_code}", p_l_cm_code, 1)
